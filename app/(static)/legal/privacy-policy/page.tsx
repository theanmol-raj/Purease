      ...
      <div className="relative px-6 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-[40rem] prose-sm prose prose-slate prose-a:font-semibold prose-a:text-sky-500 hover:prose-a:text-sky-600">
          <p className="text-sm font-light">
            This privacy policy {`("Policy") `}describes how Purease Labs Inc.{" "}
            {`("Purease", "we", "us" or "our")`} collects, protects and uses
            the personally identifiable information{" "}
            {`("Personal Information") you ("User", "you" or "your")`} may
            provide through the Purease UI website (purease.com) or in the
            course of purchasing any Purease UI products{" "}
            ...
            how you can access and update this information. This Policy does not
            apply to the practices of companies that we do not own or control,
            or to individuals that we do not employ or manage.
          </p>
          <h2 className=" text-xl font-bold pt-6">Collection of personal information</h2>
          <p className="text-sm font-light">
            ...
            to login to the Website and access any purchased Purease UI
            products.
          </p>
          <h2 className=" text-xl font-bold pt-6">Collection of non-personal information</h2>
          <p className="text-sm font-light">
          ...
          <h2 className=" text-xl font-bold pt-6">Purchases</h2>
          <p className="text-sm font-light">
            ...
            Purease does not control Paddle or its collection or use of
          ...
          <h2 className=" text-xl font-bold pt-6">Managing personal information</h2>
          <p className="text-sm font-light">
            You are able to update your Personal Information in your
            {` "Account Settings"`} on the Website. Currently this is limited to
            just your email address, as described above. You may also request
            that we delete your email address, but this will prevent you from
            accessing the products you have purchased from Purease.
          </p>
          <p className="text-sm font-light">
          ...
          <h2 className=" text-xl font-bold pt-6">Use and processing of collected information</h2>
          <p className="text-sm font-light">
          ...
          <h2 className=" text-xl font-bold pt-6">Information transfer and storage</h2>
          <p className="text-sm font-light">
          ...
          <h2 className=" text-xl font-bold pt-6">The rights of users</h2>
          <p className="text-sm font-light">
          ...
          <h2 className=" text-xl font-bold pt-6">The right to object to processing</h2>
          <p className="text-sm font-light">
          ...
          <h2 className=" text-xl font-bold pt-6">How to exercise these rights</h2>
          <p className="text-sm font-light">
            Any requests to exercise User rights can be directed to the Owner by
            email at{" "}
            <a href="mailto:support@purease.com">support@purease.com</a>.
          ...
          <h2 className=" text-xl font-bold pt-6">Privacy of children</h2>
          <p className="text-sm font-light">
          ...
          <h2 className=" text-xl font-bold pt-6">Newsletters</h2>
          <p className="text-sm font-light">
          ...
          <h2 className=" text-xl font-bold pt-6">Cookies</h2>
          <p className="text-sm font-light">
          ...
          <h2 className=" text-xl font-bold pt-6">Links to other websites</h2>
          <p className="text-sm font-light">
          ...
          <h2 className=" text-xl font-bold pt-6">Information security</h2>
          <p className="text-sm font-light">
          ...
          <h2 className=" text-xl font-bold pt-6">Data breach</h2>
          <p className="text-sm font-light">
          ...
          <h2 className=" text-xl font-bold pt-6">Legal disclosure</h2>
          <p className="text-sm font-light">
          ...
          <h2 className=" text-xl font-bold pt-6">Changes and amendments</h2>
          <p className="text-sm font-light">
          ...
          <h2 className=" text-xl font-bold pt-6">Acceptance of this policy</h2>
          <p className="text-sm font-light">
          ...
          <h2 className=" text-xl font-bold pt-6">Contacting us</h2>
          <p className="text-sm font-light">
